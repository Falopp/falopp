...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=280&section=header&text=Federico%20Falopp&fontSize=75&fontAlignY=38&animation=fadeIn&fontColor=ffffff&desc=Full-Stack%20Developer%20%26%20Blockchain%20Engineer&descAlignY=55&descSize=18)

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=26&duration=3000&pause=1000&center=true&vCenter=true&color=3DAEF7&width=800&lines=%C2%A1Hola!+Soy+Federico+%F0%9F%91%8B;Full‑Stack+Developer+%2B+Blockchain+Engineer;DeFi+Specialist+%26+Trading+Bot+Creator;Cybersecurity+Enthusiast+%F0%9F%94%92;Siempre+construyendo+el+futuro...+%F0%9F%9A%80" alt="Typing SVG" />
...
|----------|-------|--------|
| **[binance-p2p-bot](https://github.com/Falopp/binance-p2p-bot)** | `Python` `Playwright` | 🟢 Activo |
| **[Pro-Hedge-Trading](https://github.com/Falopp/Pro-Hedge-Trading)** | `Python` `Docker` `Shell` | 🟢 Activo |
| **[P2P_Profit](https://github.com/Falopp/P2P_Profit)** | `Python` `Rich` `CSV` | 🟢 Activo |
| **[CS2_bot_dmarket](https://github.com/Falopp/CS2_bot_dmarket)** | `Python` `DMarket API` | 🟢 Activo |
| **[mixer](https://github.com/Falopp/mixer)** | `Python` `BSC` `Async` | 🟡 Experimental |
...
| Proyecto | Stack | Status |
|----------|-------|--------|
| **[crypto_screener_dashboard](https://github.com/Falopp/crypto_screener_dashboard)** | `Python` `React` `FastAPI` | 🟢 Activo |
| **[data_p2p](https://github.com/Falopp/data_p2p)** | `Python` `Polars` `Plotly` | 🟢 Activo |
| **[reddit_content_downloader](https://github.com/Falopp/reddit_content_downloader)** | `Python` `AsyncIO` `Docker` | 🟢 Activo |
| **[universal-weather-bot](https://github.com/Falopp/universal-weather-bot)** | `Python` `JavaScript` `Telegram` | 🟢 Activo |
| **[guia-wallets-seguras](https://github.com/Falopp/guia-wallets-seguras)** | `Markdown` `Security Guide` | 🟢 Activo |
...
<details>
<summary><b>🔥 Click para desplegar mi stack completo</b></summary>
...
<img height="180em" src="https://github-readme-stats.vercel.app/api?username=Falopp&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true"/>
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Falopp&layout=compact&langs_count=8&theme=tokyonight"/>
...
<img src="https://github-profile-trophy.vercel.app/?username=Falopp&theme=tokyonight&no-frame=false&no-bg=false&margin-w=4&row=1" alt="GitHub Trophies"/>
